...
$(BUILD_DIR)/build_abr: $(patsubst %, ./$(BUILD_DIR)/%, build_abr.o ArbreBinaire.o ArbreBinaireRecherche.o Graph.o)
	$(CC) $^ -o $@ $(LIBS)
$(BUILD_DIR)/filtrage: $(patsubst %, ./$(BUILD_DIR)/%, filtrage.o ArbreBinaire.o ArbreBinaireRecherche.o Graph.o)
	$(CC) $^ -o $@ $(LIBS)

filtrage.o: filtrage.c ArbreBinaireRecherche.h Graph.h
